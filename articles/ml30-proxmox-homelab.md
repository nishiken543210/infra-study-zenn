---
title: "サーバー知識ゼロから HPE ML30 を買って Proxmox を入れた話"
emoji: "🖥️"
type: "tech"
...
正直に言うと、サーバーについてほとんど何も知らない状態からスタートしています。

「ラックマウント型とタワー型の違いは？」「iLO って何？」「RAID って本当に必要？」——調べれば調べるほど知らないことが出てきて、最初はどこから手をつければいいかわかりませんでした。

でも、ある時期からそれが逆に楽しくなってきた。**「知らないから買ってみよう」** という気持ちで、実機を手元に置くことにしました。頭で理解しようとするより、実際に触ったほうが早い、という判断です。
